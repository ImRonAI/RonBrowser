const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./info-NVLQJR56-CKmy5A_C.js","./index-b-9KRjub.js","./index-BO0bP-q-.css","./packet-BFZMPI3H-T-DOCff-.js","./pie-7BOR55EZ-CelaJy4x.js","./architecture-U656AL7Q-NztMV1Po.js","./gitGraph-F6HP7TQM-DeJTm1DN.js","./radar-NHE76QYJ-DqkC0C3U.js","./treemap-KMMF4GRG-BYHLHSVe.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-b-9KRjub.js";
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => {
      const { createInfoServices: createInfoServices22 } = await import("./info-NVLQJR56-CKmy5A_C.js");
  ...
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => {
      const { createPacketServices: createPacketServices22 } = await import("./packet-BFZMPI3H-T-DOCff-.js");
  ...
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(async () => {
      const { createPieServices: createPieServices22 } = await import("./pie-7BOR55EZ-CelaJy4x.js");
  ...
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => {
      const { createArchitectureServices: createArchitectureServices22 } = await import("./architecture-U656AL7Q-NztMV1Po.js");
  ...
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => {
      const { createGitGraphServices: createGitGraphServices22 } = await import("./gitGraph-F6HP7TQM-DeJTm1DN.js");
  ...
  radar: /* @__PURE__ */ __name(async () => {
    const { createRadarServices: createRadarServices2 } = await __vitePreload(async () => {
      const { createRadarServices: createRadarServices22 } = await import("./radar-NHE76QYJ-DqkC0C3U.js");
  ...
  treemap: /* @__PURE__ */ __name(async () => {
    const { createTreemapServices: createTreemapServices2 } = await __vitePreload(async () => {
      const { createTreemapServices: createTreemapServices22 } = await import("./treemap-KMMF4GRG-BYHLHSVe.js");
