const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./info-NVLQJR56-vgebDXSE.js","./index-DGawAcrk.js","./index-C0I8GuB_.css","./packet-BFZMPI3H-B-CGilWE.js","./pie-7BOR55EZ-CzPun0XA.js","./architecture-U656AL7Q-CwvkVqfW.js","./gitGraph-F6HP7TQM-C64U42K0.js","./radar-NHE76QYJ-BVzPgLic.js","./treemap-KMMF4GRG-BWzkzpLP.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-DGawAcrk.js";
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => {
      const { createInfoServices: createInfoServices22 } = await import("./info-NVLQJR56-vgebDXSE.js");
  ...
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => {
      const { createPacketServices: createPacketServices22 } = await import("./packet-BFZMPI3H-B-CGilWE.js");
  ...
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(async () => {
      const { createPieServices: createPieServices22 } = await import("./pie-7BOR55EZ-CzPun0XA.js");
  ...
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => {
      const { createArchitectureServices: createArchitectureServices22 } = await import("./architecture-U656AL7Q-CwvkVqfW.js");
  ...
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => {
      const { createGitGraphServices: createGitGraphServices22 } = await import("./gitGraph-F6HP7TQM-C64U42K0.js");
  ...
  radar: /* @__PURE__ */ __name(async () => {
    const { createRadarServices: createRadarServices2 } = await __vitePreload(async () => {
      const { createRadarServices: createRadarServices22 } = await import("./radar-NHE76QYJ-BVzPgLic.js");
  ...
  treemap: /* @__PURE__ */ __name(async () => {
    const { createTreemapServices: createTreemapServices2 } = await __vitePreload(async () => {
      const { createTreemapServices: createTreemapServices22 } = await import("./treemap-KMMF4GRG-BWzkzpLP.js");
