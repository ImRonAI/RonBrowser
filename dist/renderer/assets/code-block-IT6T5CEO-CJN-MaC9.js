import { r as reactExports, C as C$2, j as jsxRuntimeExports, D as Dt, u as u$1, c as createHighlighter, b as bundledLanguages } from "./index-DZaxnShF.js";
function r$2(e) {
  ...
  */
  CharacterClass(node, state, gen) {
    ...
    if (envFlags.bugFlagVLiteralHyphenIsRange && state.useFlagV && body.some(isLiteralHyphen)) {
      body = [m$1(45), ...body.filter((kid) => !isLiteralHyphen(kid))];
    }
